      ...
      <div className="py-8 flex flex-col justify-between items-center h-full">
        ...
        <div className="flex flex-col space-y-6 w-full items-center justify-center">
          <NavLink
            ...
            className="group cursor-pointer w-full flex justify-center relative"
            to="/"
          >
            <span className="transition duration-500 ease-in-out md:text-xl text-sm font-bold opacity-0 group-hover:md:opacity-100 absolute w-full h-full group-hover:flex justify-center items-center">
              Home
            </span>
        ...
        <div className="flex flex-col">
          <div className="rounded-full  p-3 cursor-pointer hover:md:scale-110 scale-17 duration-500">
            <a
              target="_blank"
              href="https://www.linkedin.com/in/mahmoud-ashraf-49921b1a8/"
              rel="noreferrer"
            >
              <FaLinkedinIn className="md:w-8 w-7 md:h-10 h-6 hover:text-indigo-500" />
            </a>
          </div>
          <div className="rounded-full  p-3 cursor-pointer hover:md:scale-110 scale-17 duration-500">
            <a
              target="_blank"
              href="https://github.com/mahmoud-ashraf-devloper"
              rel="noreferrer"
            >
              <FaGithub className="md:w-8 w-7 md:h-10 h-6 hover:text-indigo-500" />
            </a>
          </div>
