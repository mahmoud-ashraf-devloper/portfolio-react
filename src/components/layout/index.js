    ...
    return (
        <div className='flex '>
            ...
            <div className='fade-in-2 w-full min-h-screen md:ml-20 ml-12  text-lg '>
                ...
                <img className=' bg-repeat-y left-0 top-0 fixed blur-m min-h-screen w-screen bg-slate-900 opacity-30 ' src={HomeBg} alt='/' />
                <div className=''>
                    ...
                    <div className='min-h-[82vh] md:flex md:py-0 py-6  items-center'>
                        <Outlet />
                    </div>
